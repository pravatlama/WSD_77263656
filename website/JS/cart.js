...
function ready() {
  ...
  var addToCartButtons = document.getElementsByClassName("to-cart");
...
function purchase() {
  ...
  var total = parseFloat(totalElement.innerText.replace("Nrs ", ""));
  if (total == 0) {
...
function addItemToCart(title, price, imageSrc) {
  ...
  var cartRowContents = `
    ...
    <div class="cart-quantity cart-column">
      ...
      <button class="cart-btn btn-danger" type="button">REMOVE</button>
    </div>`;
...
function updateCartTotal() {
  ...
  for (var i = 0; i < cartRows.length; i++) {
    ...
    var price = parseFloat(priceElement.innerText.replace("Nrs ", ""));
...
var cartPageButton = document.getElementsByClassName("cart-page")[0];
var cartCloseButton = document.getElementsByClassName("close-cart")[0];
var cartPage = document.getElementsByClassName("cart-container")[0];
